          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                slug: 'declaraciones-tributarias',
              ...
              },
              {
                ...
                slug: 'formatos-plantillas',
                items: ['Documentos administrativos', 'Cartas y contratos básicos'],
                icon: FileText,
              },
            ].map((service, idx) => (
              <FadeIn key={service.slug} delay={idx * 100}>
                <Link
                  to={`/servicios/${service.slug}`}
                  className="bg-white p-8 rounded-[2rem] shadow-sm hover:shadow-[0_20px_40px_rgba(0,0,0,0.08)] border border-stone-100 transition-all duration-300 group h-full flex flex-col cursor-pointer block focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 focus-visible:ring-offset-2"
                >
                  ...
                  <span className="mt-6 inline-flex items-center justify-center gap-2 w-full py-3.5 px-5 rounded-full bg-stone-900 text-white text-sm font-bold shadow-sm group-hover:bg-amber-500 group-hover:shadow-md group-hover:shadow-amber-500/25 transition-all">
